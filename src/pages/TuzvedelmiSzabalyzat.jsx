                ...
                <script type="application/ld+json">{`
                    {
                        ...
                        "@type": "Service",
                        "name": "Tűzvédelmi szabályzat",
                        "description": "Tűzvédelmi szabályzat készítése a 101/2023. BM rendelet szerint: tűzmegelőzés, tűzjelzés, menekülési útvonalak, tűzoltó eszközök.",
                        "provider": {
                ...
                <article className="subsection">
                    <div className="content-wrapper">
                        <div className="image-container">
                            <img
                                src={szab}
                                alt="Tűzvédelmi szabályzat – szervezeti tűzvédelmi előírások és eljárások dokumentálása"
                                className="image"
                                width="600"
                                height="400"
                                loading="lazy"
