...
const TuzveszelyesTevekenyseg = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Tűzveszélyes tevékenység engedélyezése - EHS Szolgáltatás</title>
                <meta name="description" content="Alkalomszerű tűzveszélyes tevékenységek engedélyezése: hegesztési munkák, forrasztás, kockázatértékelés, biztonsági intézkedések." />
                <meta property="og:image" content={new URL(tuzveszelyes, "https://ehs-szolgaltatas.com").href} />
                <script type="application/ld+json">{`
                    {
                        "@context": "https://schema.org",
                        "@type": "Service",
                        "name": "Tűzveszélyes tevékenység engedélyezése",
                        "description": "Alkalomszerű tűzveszélyes tevékenységek engedélyezése: hegesztési munkák, forrasztás, kockázatértékelés, biztonsági intézkedések.",
                        "provider": {
                ...
                <article className="subsection">
                    <div className="content-wrapper">
                        <div className="image-container">
                            <img
                                src={tuzveszelyes}
                                alt="Tűzveszélyes tevékenység – hegesztési és egyéb nyílt lángot használó munkák engedélyezése"
                                className="image"
                                width="600"
                                height="400"
                                loading="lazy"
                        ...
                        <div className="text-container">
                            <h1>Tűzveszélyes tevékenység</h1>
