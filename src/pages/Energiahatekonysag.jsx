                ...
                <script type="application/ld+json">{`
                    {
                        ...
                        "@type": "Service",
                        "name": "Energiahatékonyság",
                        "description": "Energiahatékonysági szakreferensi szolgáltatások a 2015. évi LVII. törvény alapján. Energiafelhasználás nyomon követése, mérések, jelentések készítése.",
                        "provider": {
                        ...
                        "areaServed": "HU",
                        "serviceType": "Energiahatékonyság"
                    }
                `}</script>
            </Helmet>
                        ...
                        <div className="content-wrapper">
                            <div className="image-container">
                                <img
                                    ...
                                    alt="Energiahatékonyság – épület energetikai auditálása"
                                    className="image"
                                    width="600"
                                    height="400"
                                    loading="lazy"
                            ...
                            <div className="text-container">
                                ...
                                <ul className="custom-list" aria-label="122/2015. Korm. rendelet szerinti feladatok">
